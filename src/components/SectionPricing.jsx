            ...
            >
              {plan.popular && (
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, #DC2626 0%, #B01219 100%)",
                  }}
                >
                  POPULAIRE
                </div>
              ...
              >
                <Icon
                  icon={plan.icon}
                  className={`w-6 h-6 ${plan.color === "red" ? "text-brand-red" : "text-brand-green"}`}
                />
              </div>
              ...
              <p
                className={`text-xs sm:text-sm font-medium ${plan.color === "red" ? "text-brand-green" : "text-brand-green"}`}
              >
                {plan.tag}
              </p>
              <p className="text-slate-600 mt-1 sm:mt-2 mb-3 sm:mb-4 text-sm sm:text-base">
                {plan.desc}
              </p>
