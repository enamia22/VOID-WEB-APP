export default function SectionDigital() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-12 lg:px-24 bg-gradient-to-b from-white to-neutral-100 border-y border-black/10">
      <div className="max-w-container mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
        <div className="w-full lg:max-w-[448px] lg:max-h-[597px] h-[240px] sm:h-[320px] md:h-[400px] lg:h-[450px] rounded-xl sm:rounded-2xl bg-slate-200 shadow-lg overflow-hidden shrink-0 order-2 lg:order-1">
            ...
            {features.map(({ title, desc }) => (
              <li key={title} className="flex gap-3 sm:gap-4 items-start">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-green-50 flex items-center justify-center shrink-0">
                  <CheckIcon className="w-4 h-4 sm:w-5 sm:h-5 text-brand-green" />
                </div>
